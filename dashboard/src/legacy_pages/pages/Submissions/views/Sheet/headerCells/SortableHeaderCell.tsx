import type { HeaderCellProps } from '@/legacy_pages/pages/Submissions/views/Sheet/HeaderCell'
import type { SortDirection } from '@/legacy_pages/pages/Submissions/views/Sheet/types'
