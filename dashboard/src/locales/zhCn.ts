export default {
  ...
  'Powered by HeyForm': '由 HeyForm 驱动',
  ...
  'Upload a file or drag and drop': '上传文件或将文件拖放到此处',
  'Size limit': '大小限制',
  'Never submit passwords!': '永远不要提交密码！',
  'Report Abuse': '举报违规',
  Next: '下一个',
  Submit: '提交',
  'First Name': '姓氏',
  'Last Name': '名字',
  'Address Line 1': '地址 1',
  'Address Line 2 (optional)': '地址 2 (可选的)',
  City: '城市',
  'State/Province': '州/省',
  ...
  Yes: '是',
  No: '否',
  'Hit Shift ⇧ + Enter ↵ for new line': '按 Shift ⇧ + Enter ↵ 换行',
